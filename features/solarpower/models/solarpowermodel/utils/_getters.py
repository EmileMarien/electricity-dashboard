...
def get_total_cost(self,tariff: str='DynamicTariff',purchase_rate_injection:float=0.00414453,purchase_rate_consumption=0.0538613,data_management_cost: float =13.95,capacity_rate: float=41.3087,fixed_component_dual=111.3,fixed_component_dynamic=100.7,excise_duty_energy_contribution_rate=0,include_PV:bool=True): #TODO: fix
    """
...
def get_npv(battery_cost, total_solar_panel_cost, inverter_cost, discount_rate, annual_degradation):
    ...
    initial_cash_flow=get_total_cost(tariff="DynamicTariff")-get_total_cost(tariff="DynamicTariff",include_PV=False)
